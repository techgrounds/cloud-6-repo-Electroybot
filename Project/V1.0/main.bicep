...
param appVMImageReference object

@description('Specifies the OS disk for App VM.')
param appVMOSDisk object
...
// Deploy App Web Virtual Machine
module appVirtualMachine 'modules/virtualMachine.bicep' = if (deployVM == true) {
  name: 'deploy-appVirtualMachine'
  #disable-next-line explicit-values-for-loc-params
  params: {
    name: 'app-prd'
    zones: [
    ...
    imageReference: appVMImageReference
    osDisk: appVMOSDisk
